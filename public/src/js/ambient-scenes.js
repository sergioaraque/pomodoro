/**
 * ambient-scenes.js — Las 20 escenas de audio generativo de FocusNature.
 * Exporta una sola función: buildScene(theme, ctx, out).
 *
 * Cada escena devuelve { stop() } para poder detener todos sus nodos.
 */
...
const SCENES = {
  ...
  space:       _sceneSpace,
  deep:        _sceneDeep,
  volcano:     _sceneVolcano,
  rain:        _sceneRain,
  japan:       _sceneJapan,
  swamp:       _sceneSwamp,
  cave:        _sceneCave,
  underarctic: _sceneUnderArctic,
  savanna:     _sceneSavanna,
  alps:        _sceneAlps,
  festival:    _sceneFestival,
  jungle:      _sceneJungle,
  mars:        _sceneMars,
};

export function buildScene(theme, ctx, out) {
  const fn = SCENES[theme] || SCENES.ocean;
  return fn(ctx, out);
}
...
// ─────────────────────────────────────────────────────────────────────
//  CITY — lluvia + zumbido urbano + sirena
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
//  ARCTIC — viento polar + crujido del hielo
// ─────────────────────────────────────────────────────────────────────
function _sceneArctic(ctx, out) {
  ...
  const wLfo  = ctx.createOscillator();   wLfo.type = 'sine'; wLfo.frequency.value = 0.025;
...
// ─────────────────────────────────────────────────────────────────────
//  SPACE — hum cósmico + pulso estelar
// ─────────────────────────────────────────────────────────────────────
function _sceneSpace(ctx, out) {
  ...
  pulse.start(); pulseAM.start(); nodes.push(pulse, pulseAM);
  ...
  function scheduleSpark() {
    setTimeout(() => {
      ...
      o.connect(g); g.connect(out); o.start(t); o.stop(t + 0.31);
      scheduleSpark();
...
// ─────────────────────────────────────────────────────────────────────
//  DEEP — presión abisal + bioluminiscencia
// ─────────────────────────────────────────────────────────────────────
function _sceneDeep(ctx, out) {
  ...
  function schedulePing() {
    setTimeout(() => {
      ...
      o.connect(g); g.connect(out); o.start(t); o.stop(t + 1.9);
      schedulePing();
...
// ─────────────────────────────────────────────────────────────────────
//  VOLCANO — retumbo telúrico + lava + vapor
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
//  JAPAN — bambú + campana de templo + grillo
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
//  CAVE — resonancia mineral + gotas con eco
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
//  UNDERWATER ARCTIC — canto de beluga + hielo
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
//  SAVANNA — grillos africanos + viento + pájaro
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
//  ALPS — viento alpino + cencerro + río glaciar
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
//  FESTIVAL — bullicio + música + fuegos artificiales
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
//  JUNGLE — aves tropicales + cascada
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
//  MARS — viento marciano + pulso electromagnético
// ─────────────────────────────────────────────────────────────────────
